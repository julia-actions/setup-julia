    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!juliaPath) {
                ...
                const juliaInstallationPath = yield installer.installJulia(versionInfo, version, arch, urlOverride);
                // Add it to cache
                juliaPath = yield tc.cacheDir(juliaInstallationPath, 'julia', version.concat(urlOverride), arch);

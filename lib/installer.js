...
exports.showVersionInfo = exports.installJulia = exports.getDownloadURL = exports.getFileInfo = exports.getJuliaVersion = exports.readJuliaCompatVersions = exports.getProjectFile = exports.getJuliaVersions = exports.getJuliaVersionInfo = void 0;
...
function getJuliaVersion(availableReleases, versionInput, includePrerelease = false, juliaCompatVersions = []) {
    ...
    if (semver.valid(versionInput) == versionInput || versionInput.endsWith('nightly')) {
        ...
        let minVersion = semver.sort(minVersions.filter((v) => v !== null))[0];

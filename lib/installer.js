 ...
 */
function getProjectJuliaCompatVersions(projectInput) {
    var _a, _b;
    let compatVersions = [];
    ...
    for (let versionRange in (_b = (_a = meta.compat) === null || _a === void 0 ? void 0 : _a.julia) === null || _b === void 0 ? void 0 : _b.split(",")) {
        compatVersions.push(versionRange.trim());
    }
    return compatVersions;
}
function getJuliaVersion(availableReleases, versionInput, includePrerelease = false, projectInput = ".") {
    let version;

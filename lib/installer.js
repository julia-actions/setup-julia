...
exports.showVersionInfo = exports.installJulia = exports.getDownloadURL = exports.getFileInfo = exports.getJuliaVersion = exports.readJuliaCompatVersions = exports.validJuliaRange = exports.getProjectFile = exports.getJuliaVersions = exports.getJuliaVersionInfo = void 0;
...
function validJuliaRange(range) {
    range = range.trim();
...
exports.validJuliaRange = validJuliaRange;
/**
 * @returns An array of version ranges compatible with the Julia project
 */
function readJuliaCompatVersions(projectFileContent) {
    var _a, _b;
    let compatVersions = [];
    let meta = toml.parse(projectFileContent);
    for (let versionRange of ((_b = (_a = meta.compat) === null || _a === void 0 ? void 0 : _a.julia) === null || _b === void 0 ? void 0 : _b.split(",")) || []) {
...
exports.readJuliaCompatVersions = readJuliaCompatVersions;
function getJuliaVersion(availableReleases, versionInput, includePrerelease = false, juliaCompatVersions = []) {
    let version;
